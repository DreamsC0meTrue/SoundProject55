...
public class AudioSourceSample : MonoBehaviour
{
    ...
    //3) 씬에서 찾아서 연결하는 경우
    //4) Resources.Load() 기능을 이요해 리소스 폴더에 있는 오디오 소스의 클립을 받아오겠습니다.
    ...
    void Start()
    {
        ...
        //GameObject이기 떄문에 GetComponent<T>를 이어 작성함으로써 오브젝트가 가진 콤포넌트의 값을 return합니다.
        ...
        //Resouce.Load()는 리소스 폴더에서 오브젝트를 찾아 로드하는 기능입니다.
        //이떄 받아오는 값은 Object이므로, as 클래스명을 통해 해당 데이터가 어떤 형태인지 표현해주면
        //그 형태로 받아오게 됩니다.
        ...
        //unityWebRequese의 GetAudioClip 기능 활용
